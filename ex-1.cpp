...
class Pessoa: public Comparable<Pessoa> {
	public:
		...
		int compares_to(Pessoa p) { return this->nome.compare(p.get_nome()); }
...
// int Pessoa::compares_to(Pessoa p){
// 	return this->nome.compare(p.get_nome());
// }
...
// std::ostream& operator <<(std::ostream& os, const Aluno& al) {
// 	os << al.toString();
// }